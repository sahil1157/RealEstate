        ...
        <div className=' flex flex-col mx-0 items-center justify-center  lg:flex md:grid md:grid-cols-2  lg:flex-row gap-9'>
{
          location.map((i)=>{
            return(
              <div className='box-border border-2 md:border-0 rounded-md shadow-lg md:shadow-md w-full h-[35vh] md:h-52 flex flex-col justify-center items-center cursor-pointer'>
