...
const AgentProps = ({items}) => {
  return (
    <div>
      <div className=''>
          <div className='bg-white relative box-border min-h-[300px] max-w-[294px] border-b-2 rounded-lg shadow-lg'>
            ...
            <div className='items-center text-center p-4 justify-center'>
              <h1 className='text-xl text-black font-Oldenburg'>{items.Name}</h1>
