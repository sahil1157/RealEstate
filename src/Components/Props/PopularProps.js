        ...
        <div className=''>
            <div className=''>
                <div className='  pt-12 '>
                    ...
                    <div className=' pt-10 md:pt-4 flex flex-col mx-0 justify-center items-center md:flex-row md:justify-between'>
                        <h1 className=' font-[open sans] text-2xl flex-wrap lg:text-4xl'>{Residences}</h1>
                        <div className=' lg:cursor-pointer flex flex-row gap-2 pt-5 md:pt-0'>
